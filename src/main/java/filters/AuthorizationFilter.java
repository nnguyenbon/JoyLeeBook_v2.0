...
//    private static final List<String> PUBLIC_PATHS = new ArrayList<>(Arrays.asList(
//            "/login",
//            "/register",
//            "/homepage",
//            "/",
...
//    ));
//
//    private static final List<String> READER_PATHS = new ArrayList<>(Arrays.asList(
//            "/profile",
//            "/register-author",
//            "report-chapter",
//            "like-chapter",
...
//    ));
//
//    private static final List<String> AUTHOR_PATHS = new ArrayList<>(Arrays.asList(
//            "/my-series",
//            "/manage-coauthors",
//            "/manage-chapters",
//            "/my-chapters",
...
//    ));
//
//    private static final List<String> STAFF_PATHS = new ArrayList<>(Arrays.asList(
//            "/staff",
//            "/create-genre",
//            "/delete-genre",
//            "/edit-genre"
//    ));
//
//    private static final List<String> ADMIN_PATHS = new ArrayList<>(Arrays.asList(
//            "/admin",
//            "/user/manage"
//    ));
//
//    private static final List<String> SHARED_PATHS = new ArrayList<>(Arrays.asList(
//            "/logout",
//            "/change-password"
//    ));
//
