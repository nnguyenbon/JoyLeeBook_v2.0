 ...
 * sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum f
 * acilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil im
 * pedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellen
 * dus. Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et volupt
 * ates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente delectus, ut au
 * t reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat."
 *
 * 1914 translation by H. Rackham
 * "On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralize
 * d by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble
 * that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, wh
 * ich is the same as saying through shrinking from toil and pain. These cases are perfectly simple and easy to d
 * istinguish. In a free hour, when our power of choice is untrammelled and when nothing prevents our being able t
 * o do what we like best, every pleasure is to be welcomed and every pain avoided. But in certain circumstances
