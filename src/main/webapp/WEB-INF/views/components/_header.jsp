        ...
        <c:if test="${loginedUser != null}">
                                        ...
                                        <c:choose>
                                            ...
                                            <c:when test="${noti.title == 'Co-Author Invitation' or fn:contains(noti.urlRedirect, 'action=coauthor_invite')}">
                                                ...
                                                <c:if test="${!noti.read}">
                                                    ...
                                                    <c:set var="seriesIdMatch"
                                                           value="${fn:substringAfter(urlParams, 'seriesId=')}"/>
                                                    <c:set var="seriesId"
                                                           value="${fn:substringBefore(seriesIdMatch, '&')}"/>
            ...
            <div class="col-span-1 relative">
                <button id="BtnAvatar" class="px-4 py-2 flex items-center gap-1">
                    <span class="block w-10 h-10 bg-gray-300 rounded-full">
                        <img
        ...
        item.addEventListener('click', function (e) {
            ...
            if (notiId && !isRead) {
                ...
                fetch('${pageContext.request.contextPath}/notification/mark-read', {
                    ...
                    .catch(() => window.location.href = originalUrl);
            }
        });
    });
