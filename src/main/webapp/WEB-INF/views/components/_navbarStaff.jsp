...
<aside class="w-56 border-r border-gray-300 flex flex-col justify-between">
    <div>
        ...
        <nav class="">
            ...
            <a href="${pageContext.request.contextPath}/series/list?filterByStatus=pending" class="flex items-center px-4 py-2   ${activePage == 'series' ? 'bg-[#195DA9]/10 text-[#195DA9] font-medium' : 'hover:bg-gray-100'} ">
                <i class="fa-solid fa-book"></i>
                <span class="ml-2">Series Review</span>
            </a>
            <a href="${pageContext.request.contextPath}/chapter/list?filterByStatus=pending" class="flex items-center px-4 py-2   ${activePage == 'chapters' ? 'bg-[#195DA9]/10 text-[#195DA9] font-medium' : 'hover:bg-gray-100'} ">
                <i class="fa-solid fa-book"></i>
