...
<div class="flex h-screen">
    ...
    <main class="flex-1 bg-gray-100">
        ...
        <div class="border-b  flex items-center px-9">
            <button class="text-xl font-bold border-b-4 px-4 border-[#195DA9]">Chapter Report</button>
            <button class="text-xl text-gray-500 px-4 hover:text-[#195DA9]">Comment Report</button>
        ...
        <!-- List Header -->
        <p class="text-gray-500 text-sm mb-1 px-9">Total: 300</p>
        ...
        <div class="space-y-3 px-9">
            ...
            <div class="flex items-center justify-between border rounded-lg bg-white px-4 py-3 hover:shadow-sm">
                <div class="flex items-center gap-4">
                    <div class="px-4">
                        <p class="font-semibold">Chapter 43: The Awakening</p>
                        <P class="text-gray-500">Series: Choronicles of the Mystic Realm</P>
                    </div>
                </div>
                <div class="flex items-center gap-10 text-sm">
                    <p>Reported by User123</p>
                    <span
                            class="w-20 text-center py-0.5 rounded-full bg-blue-100 text-blue-700 text-xs">Resolved</span>

                    <div class="flex items-center gap-2 text-sm">
                        <p class="text-gray-500 mr-3">25/09/2025</p>
                        ...
                        <div class="relative">
                            ...
                            <div
                                ...
                                <button
                                        class="block w-full text-[#42CC75] flex gap-2 px-4 py-2 text-sm  hover:bg-gray-100"><svg
            ...
            <div class="flex items-center justify-between border rounded-lg bg-white px-4 py-3 hover:shadow-sm">
                ...
                <div class="flex items-center gap-10 text-sm">
                    <p>Reported by User123</p>
                    <span
                            class="w-20 text-center py-0.5 rounded-full bg-yellow-100 text-yellow-700 text-xs">Pending</span>
