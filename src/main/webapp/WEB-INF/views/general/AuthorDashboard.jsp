...
<main class="mt-10 grid grid-cols-12 gap-x-5 gap-y-3 items-center">
    <div class="col-span-12 grid grid-cols-12 items-center">
        <h1 class="col-span-11 text-5xl font-bold text-[#195DA9] mb-5">Author Dashboard</h1>
        <a href="${pageContext.request.contextPath}/series/add"
           class="flex items-center gap-2 bg-[#195DA9] hover:bg-blue-700 text-white font-semibold w-full h-10 px-4 py-2 rounded-md shadow-sm transition">
