    ...
    <div class="bg-white shadow-lg shadow-gray-400 rounded-2xl px-5 py-2">
        <div class="flex justify-between items-center">
            ...
            <div class="border-b border-gray-200 flex items-center gap-5 mb-3">
                <a href="${pageContext.request.contextPath}/report?action=list&type=chapter" id="tab-chapter" data-type="chapter" class="tab-btn text-xl text-[#195DA9] border-b-4 py-1 border-[#195DA9]">Chapter Report</a>
                <a href="${pageContext.request.contextPath}/report?action=list&type=comment" id="tab-comment" data-type="comment" class="tab-btn text-xl text-gray-500 border-b-4 border-white py-1 hover:text-[#195DA9]">Comment Report</a>
            </div>
        </div>
        ...
        <div class="overflow-x-auto rounded-sm mb-3">
            <table class="min-w-full text-sm text-left">
                ...
                <c:forEach var="report" items="${reportChapterDTOList}">
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3">${report.id}</td>
                        <td class="px-4 py-3">
                            <div class="flex flex-col">
                                <p class="font-semibold text-gray-800">Chapter ${report.chapterNumber}: ${report.title}</p>
                                <p class="text-gray-500 text-sm">Series: ${report.seriesTitle}</p>
                            </div>
                        </td>
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="relative flex justify-end gap-2 text-left">
                                <a href="${pageContext.request.contextPath}/report?action=detail&reportId=${report.id}&type=chapter"
