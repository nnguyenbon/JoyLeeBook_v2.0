        ...
        <div class="p-9">
            <div class="border rounded-lg bg-white px-4 py-3 mb-3 hover:shadow-sm transition">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        <div class="px-4">
                            <p class="text-xl text-[#195DA9] font-bold">Chapter ${chapter.chapterNumber}: ${chapter.title}</p>
                    ...
                    <div class="flex items-center gap-10 text-sm">
                        ...
                        <div class="flex items-center gap-2 text-sm">
                            <p class="text-gray-500 mr-3">Created date: ${chapter.createdAt}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-5">
                <div class="border-2 rounded-lg bg-white mb-3 px-4">
                    ...
                    <p class="px-4 py-2 text-gray-700">${chapter.content}</p>
                </div>
            </div>
